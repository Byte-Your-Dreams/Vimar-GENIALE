...
Deno.test("ChunkAdapter: obtainSimilarChunk should return a list of Chunks (integration)", async () => {
  // Arrange
...
Deno.test("ChunkAdapter: upsertChunk should return a successful DBInsertResponse (integration)", async () => {
  // Arrange
  const mockRepository = {
...
Deno.test("ChunkAdapter: upsertChunk should return a failure DBInsertResponse if upsert fails (integration)", async () => {
  // Arrange
  const mockRepository = {
    upsertChunk: async (chunk: SupabaseChunk) => {
...
Deno.test("ChunkAdapter: removeExtraChunk should return a successful DBInsertResponse (integration)", async () => {
  // Arrange
  const mockRepository = {
...
Deno.test("ChunkAdapter: removeExtraChunk should return a failure DBInsertResponse if delete fails (integration)", async () => {
  // Arrange
  const mockRepository = {
    removeExtraChunk: async (document: SupabaseDocument) => {
