...
Deno.test("Integration - GetProductUseCase - getProduct - success by name", async () => {
...
Deno.test("Integration - GetProductUseCase - getProduct - success by ID", async () => {
    const mockPort = createMockGetProductPort();
    const useCase = new GetProductUseCase(mockPort);
...
Deno.test("Integration - GetProductUseCase - getProduct - product not found", async () => {
    const mockPort = createMockGetProductPort();
    const useCase = new GetProductUseCase(mockPort);
...
Deno.test("Integration - GetProductUseCase - getProduct - failure", async () => {
