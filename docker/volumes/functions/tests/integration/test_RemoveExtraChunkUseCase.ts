...
Deno.test("Integration - RemoveExtraChunkUseCase - removeExtraChunk - success", async () => {
    ...
    assertEquals(result.getAnswer(), "Extra chunks removed successfully", "Should return the correct success message");
});

Deno.test("Integration - RemoveExtraChunkUseCase - removeExtraChunk - failure", async () => {
